...
class InfoCard {
	...
	static {
		textColors.put(170, R.color.white);
		textColors.put(340, R.color.yellow);
		textColors.put(680, R.color.orange);
	}
	...
	public void refresh(@NotNull LogEntry withEntry) {
		Preconditions.checkNotNull(withEntry, "entry must not be null");
